...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            ...
            canMove = (moveDir.x < -.6f || moveDir.x > +.6f) && !Physics.CapsuleCast(transform.position, transform.position + Vector3.up * playerHeigth, playerRadius, moveDirX, moveDistance);
            ...
            else
            {
                ...
                canMove = (moveDir.z < -.6f || moveDir.z > +.6f) && !Physics.CapsuleCast(transform.position, transform.position + Vector3.up * playerHeigth, playerRadius, moveDirZ, moveDistance);
