...
public class TutorialUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI keyGamepadIneractText;
    ...
    private void UpdateVisual()
    {
        ...
        keyGamepadIneractText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_Interact);
